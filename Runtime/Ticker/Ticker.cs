...
namespace PackageTickerClass.Runtime
{
    public class Ticker : MonoBehaviour
    {
        ...
        private struct Tick
        {
            ...
            public Tick(float duration, Action<float> onUpdate = null, Action onDone = null,
                Func<TickStop> checkStop = null, Action onStart = null)
